        ...
        // if (permission.Permissions == "Admin" || permission.Permissions == "Instructor") {
            ...
            switch (req.body.operation) {
                ...
                case "DELETE":
                    ...
                    break;
                case "UPDATE":
                    connection.query(`UPDATE dayofweek SET Weekday = '${req.body.weekday}', StartTime = '${req.body.startTime}', EndTime = '${req.body.endTime}' WHERE TimeslotID = '${req.body.timeslotID}'`, (err, result) => {
                        try {
                            if (err) throw err;
