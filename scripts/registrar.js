...
function AddItemsToTable(
  ...
  td0.innerHTML = `<td class="row_data_time column100 column1 align-bottom" id = "time_id" data-column="column1" row_id_time="` + row_id + `" style ="padding-left: 3rem" col_name_time="Hora" ">` + counterStart++ + `:00 - ` + counterEnd++ + `:00</td>`
  td1.innerHTML = '<td class="column100 column2" row_id_register="' + row_id + '" data-column="column2"><span class = "show_me" style="color: ' + styleMon + '"><a data-bs-toggle="tooltip" data-bs-placement="top" title="Lunes" class="row_data_register btn_click" row_members ="' + monday07MembersNumbers + '" row_day ="' + 1 + '" row_num ="' + idCounter + '" edit_type="click" col_name_register_user="' + AMTimeNumber + rowCounter + AMTime + '/monday" col_name_status = "' + monday07Stado + '" col_name_register="Description" "><h5>' + monday07StatusTag + '</h5></br></br>Precio: ' + monday07Precio + 'Gs</br>' + monday07Stado + '</a></span></td>';
  td2.innerHTML = '<td class="column100 column3" row_id_register="' + row_id + '" data-column="column3"><span class = "show_me" style="color: ' + styleTues + '"><a data-bs-toggle="tooltip" data-bs-placement="top" title="Martes" class="row_data_register btn_click" row_members ="' + tuesday07MembersNumbers + '" row_day ="' + 2 + '" row_num ="' + idCounter + '" edit_type="click" col_name_register_user="' + AMTimeNumber + rowCounter + AMTime + '/tuesday" col_name_status = "' + tuesday07Stado + '" col_name_register="Description" "><h5>' + tuesday07StatusTag + '</h5></br></br>Precio: ' + tuesday07Precio + 'Gs</br>' + tuesday07Stado + '</a></span></td>';
  td3.innerHTML = '<td class="column100 column4" row_id_register="' + row_id + '" data-column="column4"><span class = "show_me" style="color: ' + styleWed + '"><a data-bs-toggle="tooltip" data-bs-placement="top" title="Miercoles" class="row_data_register btn_click" row_members ="' + wed07MembersNumbers + '" row_day ="' + 3 + '" row_num ="' + idCounter + '" edit_type="click" col_name_register_user="' + AMTimeNumber + rowCounter + AMTime + '/wednesday" col_name_status = "' + wed07Stado + '" col_name_register="Description" "><h5>' + wed07StatusTag + '</h5></br></br>Precio: ' + wed07Precio + 'Gs</br>' + wed07Stado + '</a></span></td>';
  td4.innerHTML = '<td class="column100 column5" row_id_register="' + row_id + '" data-column="column5"><span class = "show_me" style="color: ' + styleThurs + '"><a data-bs-toggle="tooltip" data-bs-placement="top" title="Jueves" class="row_data_register btn_click" row_members ="' + thurs07MembersNumbers + '" row_day ="' + 4 + '" row_num ="' + idCounter + '" edit_type="click" col_name_register_user="' + AMTimeNumber + rowCounter + AMTime + '/thursday" col_name_status = "' + thurs07Stado + '" col_name_register="Description" "><h5>' + thurs07StatusTag + '</h5></br></br>Precio: ' + thurs07Precio + 'Gs</br>' + thurs07Stado + '</a></span></td>';
  td5.innerHTML = '<td class="column100 column6" row_id_register="' + row_id + '" data-column="column6"><span class = "show_me" style="color: ' + styleFri + '"><a data-bs-toggle="tooltip" data-bs-placement="top" title="Viernes" class="row_data_register btn_click" row_members ="' + fri07MembersNumbers + '" row_day ="' + 5 + '" row_num ="' + idCounter + '" edit_type="click" col_name_register_user="' + AMTimeNumber + rowCounter + AMTime + '/friday" col_name_status = "' + fri07Stado + '" col_name_register="Description" "><h5>' + fri07StatusTag + '</h5></br></br>Precio: ' + fri07Precio + 'Gs</br><span id = "stato-desc">' + fri07Stado + '</span></a></span></td>';
  td6.innerHTML = '<td class="column100 column7" row_id_register="' + row_id + '" data-column="column7"><span class = "show_me" style="color: ' + styleSat + '"><a data-bs-toggle="tooltip" data-bs-placement="top" title="Sabado" class="row_data_register btn_click" row_members ="' + sat07MembersNumbers + '" row_day ="' + 6 + '" row_num ="' + idCounter + '" edit_type="click" col_name_register_user="' + AMTimeNumber + rowCounter + AMTime + '/saturday" col_name_status = "' + sat07Stado + '" col_name_register="Description" "><h5>' + sat07StatusTag + '</h5></br></br>Precio: ' + sat07Precio + 'Gs</br>' + sat07Stado + '</a></span></td>';
  td7.innerHTML = '<td class="column100 column8" row_id_register="' + row_id + '" data-column="column8"><span class = "show_me" style="color: ' + styleSun + '"><a data-bs-toggle="tooltip" data-bs-placement="top" title="Domingo" class="row_data_register btn_click" row_members ="' + sun07MembersNumbers + '" row_day ="' + 7 + '" row_num ="' + idCounter + '" edit_type="click" col_name_register_user="' + AMTimeNumber + rowCounter + AMTime + '/sunday" col_name_status = "' + sun07Stado + '" col_name_register="Description" "><h5>' + sun07StatusTag + '</h5></br></br>Precio: ' + sun07Precio + 'Gs</br>' + sun07Stado + '</a></span></td>';
